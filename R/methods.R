...
#' @param group_label_fontsize Font size for group labels (default: 8)
#' @param group_name_fontsize Font size for group annotation name (default: 8)
#' @param show_group_name Logical, whether to show the group annotation name (default: TRUE)
#' @param group_strip_height Height of row group strip as a grid unit (default: 9pt)
#' @param group_strip_width Width of column group strip as a grid unit (default: 9pt)
