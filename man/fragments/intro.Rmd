...
We can customise annotation sizes, using the `grid::unit()`
...
pasilla_plus |>
	...
	add_tile(condition, size = unit(0.3, "cm")) |>
	add_point(activation, size = unit(0.3, "cm")) |>
	add_tile(act, size = unit(0.3, "cm")) |>
	add_bar(size, size = unit(0.3, "cm")) |>
	add_line(age, size = unit(0.3, "cm"))
```
