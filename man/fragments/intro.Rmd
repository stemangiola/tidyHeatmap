...
```{r distance, fig.width=8, fig.height=8}
...
```{r grouping, fig.width=8, fig.height=8}
...
```{r grouping2, fig.width=8, fig.height=8}
mtcars_tidy_groupings |> 
	group_by(vs, property_group) |>
	heatmap(
...
```{r split2, fig.width=8, fig.height=8}
mtcars_tidy |> 
	heatmap(
		`Car name`, Property, Value,	
		scale = "row",
...
```{r custom, fig.width=8, fig.height=8}
mtcars_tidy |> 
	heatmap(
		`Car name`, 
		Property, 
...
```{r redblue, fig.width=8, fig.height=8}
mtcars_tidy |> 
	heatmap(
		`Car name`, 
		Property, 
...
```{r flexible, fig.width=8, fig.height=8}
mtcars_tidy |> 
	heatmap(
		`Car name`, 
		Property, 
...
```{r customtile, fig.width=8, fig.height=8}
mtcars_tidy |> 
	heatmap(
		`Car name`, 
		Property, 
...
```{r customtile2, fig.width=8, fig.height=8}
mtcars_tidy |> 
	heatmap(
		`Car name`, 
		Property, 
...
```{r multiple, fig.width=8, fig.height=8}
tidyHeatmap::pasilla |>
...
```{r nolegend, fig.width=8, fig.height=8}
...
```{r manyannotations, fig.width=8, fig.height=8}
...
```{r size, fig.width=8, fig.height=8}
pasilla_plus |>
	heatmap(
		.column = sample,
		.row = symbol,
...
```{r layer, fig.width=8, fig.height=8}
tidyHeatmap::pasilla |>
...
```{r layertext, fig.width=8, fig.height=8}
tidyHeatmap::pasilla |>
...
```{r sidebyside, warning=FALSE, fig.width=8, fig.height=8}
...
```{r borders, fig.width=8, fig.height=8}
mtcars_tidy |> 
	heatmap(
		`Car name`, Property, Value,	
		scale = "row", 
...
```{r droprow, fig.width=8, fig.height=8}
mtcars_tidy |> 
	heatmap(
		`Car name`, Property, Value,	
		scale = "row", 
...
```{r reorder, fig.width=8, fig.height=8}
library(forcats)
mtcars_tidy |> 
...
```{r sizedendro, fig.width=8, fig.height=8}
mtcars_tidy |> 
	mutate(`Car name` = forcats::fct_reorder(`Car name`, `Car name`, .desc = TRUE)) %>% 
	heatmap(
		`Car name`, Property, Value,	
...
```{r sizecolumns, fig.width=8, fig.height=8}
mtcars_tidy |> 
	mutate(`Car name` = forcats::fct_reorder(`Car name`, `Car name`, .desc = TRUE)) %>% 
	heatmap(
		`Car name`, Property, Value,	
...
```{r sidelegend, fig.width=8, fig.height=8}
...
```{r title, fig.width=8, fig.height=8}
mtcars_tidy |> 
    heatmap(`Car name`, Property, Value,    scale = "row"   ) |>
    as_ComplexHeatmap() |>
    ComplexHeatmap::draw(
...
```{r patchworkintegrate, fig.width=8, fig.height=8}
library(ggplot2)
library(patchwork)
...
```{r title2, fig.width=8, fig.height=8}
mtcars_tidy |> 
    heatmap(`Car name`, Property, Value,  scale = "row" ) |>
    wrap_heatmap() +
